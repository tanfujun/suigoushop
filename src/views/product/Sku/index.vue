<template>
  <div class="app-container">
    ...
    <!-- 表格 -->
    <el-table style="width: 100%" border :data="keyword?searchRecords:records">
      <el-table-column
        type="index"
        label="序号"
        width="80"
...
export default {
  ...
  methods: {
    async searchSku(keyword){
      let result = await this.$API.sku.reqSearchSku(keyword)
      this.records = result
    ...
    async getSkuList(pages = 1) {
      ...
      if(!this.keyword){
        ...
        this.searchRecords = this.records.slice((page-1)*limit,page*limit)
